...
POST  /auth/login/
POST  /auth/register/
GET   /objects/{bucket_name}/list/
POST  /objects/{bucket_name}/upload/
DELETE /objects/{bucket_name}/{key}/
POST  /objects/{bucket_name}/rename/
POST  /objects/{bucket_name}/restore/

🧑‍💻 Cài đặt & chạy dự án
1️⃣ Clone repo
git clone https://github.com/<tên_github_của_bạn>/cloud-frontend.git
cd cloud-frontend

2️⃣ Cài đặt dependencies
npm install

3️⃣ Cấu hình file axiosClient.js

Cập nhật baseURL cho đúng địa chỉ backend:
